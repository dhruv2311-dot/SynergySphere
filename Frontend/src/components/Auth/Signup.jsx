        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="hidden md:flex flex-col items-center justify-center px-10 py-12 bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500 relative">
            ...
            <div className="z-10 flex flex-col items-center">
              ...
              <p className="text-white/90 mt-3 text-center max-w-xs">Join SynergySphere to collaborate, create, and grow together.</p>
            </div>
          ...
          <div className="px-6 py-8 md:py-12 md:px-10 lg:px-14">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="hidden sm:flex items-center gap-3">
                ...
                <Link to="/login" className="text-sm text-blue-600 font-medium">Log In</Link>
              </div>
            </div>

            <p className="text-sm text-gray-500 mb-6">Sign up to access your SynergySphere workspace</p>
            ...
            <div className="space-y-4">
              ...
              <button className="w-full mt-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-300">Sign Up</button>
              ...
              <div className="grid grid-cols-3 gap-3 mt-4">
                <button aria-label="Sign up with Google" className="flex items-center justify-center rounded-lg border border-gray-200 px-3 py-2 text-sm font-medium">
                ...
                <button aria-label="Sign up with Github" className="flex items-center justify-center rounded-lg border border-gray-200 px-3 py-2 text-sm font-medium">
                ...
                <button aria-label="Sign up with Twitter" className="flex items-center justify-center rounded-lg border border-gray-200 px-3 py-2 text-sm font-medium">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="text-center mt-4 text-sm text-gray-600">
                By signing up you agree to our <button className="text-blue-600">Terms</button> and <button className="text-blue-600">Privacy Policy</button>.
              </div>
            </div>
          </div>
